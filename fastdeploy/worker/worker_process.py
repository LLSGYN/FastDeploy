...
def parse_args():
    ...
    parser.add_argument("--qwen_rope_enable_yarn", action="store_true", help="Enable YaRN rotary embedding for Qwen-family models.")
    parser.add_argument("--qwen_rope_scaling_factor", type=float, default=None, help="YaRN rope scaling factor.")
